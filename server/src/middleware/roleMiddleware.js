...
const checkCompanyAccess = async (req, res, next) => {
  try {
    // Support multiple possible parameter names (companyId, company)
    const companyId = req.params.companyId || req.params.id || req.body.companyId || req.body.company || req.query.companyId || req.query.company
    ...
    // Validate companyId shape to avoid cast errors
    ...
    const msg = process.env.NODE_ENV === 'production'
      ...
      : `Error checking company access: ${error.message}`
