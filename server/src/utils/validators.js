...
const registerSchema = Joi.object({
  ...
  companyType: Joi.string().valid('factory', 'shop', 'showroom', 'warehouse', 'service', 'retail', 'wholesale', 'other').optional()
})
...
const companySchema = Joi.object({
  ...
  businessType: Joi.string().valid('factory', 'shop', 'showroom', 'warehouse', 'service', 'retail', 'wholesale', 'other').required(),
